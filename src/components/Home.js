...
function Home() {
  return (
    <>
      ...
      <div
        id="m"
        style={{ background: "linear-gradient(90deg, #90ff90, #e6ffe6)" }}
      >
        <div
      ...
      <div id="bg">
        <div id="content">
          <div className="head container-fluid" id="abc">
            ...
            <div>
              <p>
                Anything that you do with complete awareness is YOGA. Yoga
                offers us a chance to add energy, strength and beauty and soul.
                It is the art of finding peace from within. Yoga gives you an
                opportunity to be YOU, the true you.
              </p>
              <p>
                Founded by Deepali Gupta, Stretch 'N' Smile yoga aims to make
                yoga a wholesome experience for everyone. It provides a space
                for practice and growth, and tools to make you a better version
                of yourself.
              </p>
              <p>
                Yoga can happen anywhere, anytime, and in any form. There is no
                perfect place, time or attire for yoga. If you sit back and
                relax, take a deep breath and let the calmness flow through your
                body, yoga is happening to you. You cannot do yoga. In fact,
